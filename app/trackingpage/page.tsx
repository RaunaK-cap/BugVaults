...
const page = () => {
  return (
    <div className="min-h-screen w-full bg-black absolute">
      <main className="">
        <div className="bg-black w-full p-1 flex gap-5 justify-between items-center">
          ...
          <div className="text-white">
            <Badge className="text-sm rounded-lg  px-10 bg-yellow-500 text-black font-medium flex gap-4">
              {<FaFireAlt />}
              Track your Errors & Learn it{" "}
            </Badge>
          </div>
          <div className="text-gray-900  flex items-center gap-4 pl-4 pr-4">
            <button className="p-1 bg-neutral-800 rounded-lg px-2">
            
              Dark
            </button>
            <button className="p-1 bg-yellow-500 px-2 rounded-lg hover:cursor-pointer text-md">
        ...
        <div className="flex gap-4 p-2 text-white">
          <div className=" min-h-[93vh] w-[50rem]  bg-gray-200/10 border border-gray-600  rounded-lg">
            <div className=" border-b space-y-2 border-gray-800">
              <Badge className=" mx-45 mt-1 mb-1 px-5 text-sm rounded-md bg-gray-300/10 text-white transition-all duration-300 group cursor-default  ">
                {
            ...
            <div className="m-2">
              ...
              <div className="mt-2">
                  <button className="w-full flex justify-center items-center gap-4  bg-neutral-200 text-black p-2 rounded hover:cursor-pointer">
                    Save {<CiSaveUp2 size={20} className="text-lg" />}
                  </button>
                </div>
            </div>
          </div>
          ...
          <div className="bg-gray-200/10  border border-gray-600 h-[93vh] rounded-lg flex-col w-full">
            ...
            >
              <div className=" ml-15   mt-2 h-[25rem] w-[50rem] flex gap-2">
                ...
                <div
                  className=" w-full  gap-2 p-4 pl-10 border overflow-hidden overflow-y-scroll bg-red-800/10 border-gray-900 rounded-lg text-xs"
                  style={{ scrollbarWidth: "none" }}
                >
