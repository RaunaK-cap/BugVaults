  ...
  <main className=''>
    <div className='bg-black w-full p-1 flex gap-5 justify-between items-center'> 
      <div className='flex ml-6 text-white items-center gap-2'>
              ...
              <Link  href={"/"} className='text-md font-semibold '> BugVaults</Link>
      </div>
      ...
      <div className='text-gray-900  flex items-center gap-4 pl-4 pr-4'>
        <button className='p-1 bg-neutral-800 rounded-lg px-2'> Dark </button>
        <button className='p-1 bg-yellow-500 px-2 rounded-lg hover:cursor-pointer text-md'> Log out </button>
      </div>
    ...
    <div className=' min-h-[93vh] w-[50rem]  bg-gray-200/10 border border-gray-600  rounded-lg'>
      ...
      <div className='m-2'>
        <div>
          ...
          <div className='mt-26'>
          <button className="w-full flex justify-center items-center gap-4  bg-neutral-200 text-black p-2 rounded hover:cursor-pointer">Save {<CiSaveUp2 size={20} className='text-lg'/>}</button>
          </div>
